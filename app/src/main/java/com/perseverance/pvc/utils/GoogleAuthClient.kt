...
class GoogleAuthClient(
    ...
    private fun getGoogleSignInClient(): GoogleSignInClient {
        // Fallback to placeholder if not configured (prevents crash, but login will fail)
        val clientId = "MISSING_WEB_CLIENT_ID" 
        
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken(clientId) // Replace with Web Client ID from Firebase Console 
            .requestEmail()
            .build()
